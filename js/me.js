...
Eager.siteId = "Q1X4bFOTwg";
Eager.generation = "20160729214626-1872";
...
Eager.installs["MFBjSiXCRsCL"] = {
    appId: "HrJt4yHuuL4e",
    scope: {}
};;
Eager.installs["MFBjSiXCRsCL"].options = {
    "behavior": {
        "outMode": "out"
    },
...
if (Eager.matchPage(Eager.installs['MFBjSiXCRsCL'].URLPatterns)) {
    (function (Math) {
        var trimLeft = /^\s+/,
            trimRight = /\s+$/,
            tinyCounter = 0,
...
if (Eager.matchPage(Eager.installs['MFBjSiXCRsCL'].URLPatterns)) {
    ...
    (function () {
        ...
        var options = Eager.installs['MFBjSiXCRsCL'].options;
        var element = void 0;
        ...
        window.Eager.installs['MFBjSiXCRsCL'].scope = {
